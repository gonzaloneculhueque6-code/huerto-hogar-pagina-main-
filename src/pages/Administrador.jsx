...
export default function Administrador({ user, setUser, productos, setProductos }) {
  ...
  const [ordenes, setOrdenes] = useState(getInitialOrders());
        ...
        <div className="container-fluid">
          ...
          <ul className="navbar-nav me-auto mb-2 mb-lg-0 nav-pills">
            <li className="nav-item">
              <Link to="#" className={`nav-link text-dark ${activeTab === 'dashboard' ? 'active button text-white' : ''}`}
                onClick={() => setActiveTab('dashboard')}>
                <i className="fas fa-tachometer-alt me-1"></i> Inicio
              </Link>
            </li>
            <li className="nav-item">
              <Link to="#" className={`nav-link text-dark ${activeTab === 'ordenes' ? 'active button text-white' : ''}`}
                onClick={() => setActiveTab('ordenes')}>
                <i className="fas fa-shopping-cart me-1"></i> Órdenes
              </Link>
            </li>
            <li className="nav-item">
              <Link to="#" className={`nav-link text-dark ${activeTab === 'productos' ? 'active button text-white' : ''}`}
                onClick={() => setActiveTab('productos')}>
                <i className="fas fa-boxes me-1"></i> Productos
              </Link>
            </li>
            <li className="nav-item">
              <Link to="#" className={`nav-link text-dark ${activeTab === 'usuarios' ? 'active button text-white' : ''}`}
                onClick={() => setActiveTab('usuarios')}>
                <i className="fas fa-users me-1"></i> Usuarios
              </Link>
            </li>
            <li className="nav-item">
              <Link to="#" className={`nav-link text-dark ${activeTab === 'reportes' ? 'active button text-white' : ''}`}
